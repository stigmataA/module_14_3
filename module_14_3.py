...
async def get_buying_list(message):
    with open('files/6.png', 'rb') as img1:
        await message.answer_photo(img1, f'Название: Product1 | Описание: описание 1 | Цена: 100 р')
    with open('files/5.png', 'rb') as img2:
        await message.answer_photo(img2, f'Название: Product2 | Описание: описание 2 | Цена: 200р')
    with open('files/4.png', 'rb') as img3:
        await message.answer_photo(img3, f'Название: Product3 | Описание: описание 3 | Цена: 300р')
    with open('files/3.png', 'rb') as img4:
        await message.answer_photo(img4, f'Название: Product4 | Описание: описание 4 | Цена: 400р')
